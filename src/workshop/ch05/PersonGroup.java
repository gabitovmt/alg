...
class PersonGroup {
    ...
    public void drawLink(Graphics var1, int var2) {
        ...
        int var9 = var3 + 17;
        int var8 = var4 + 17 - 3;
        var1.drawLine(var9, var8, var9, var8 + 19);
        var1.drawLine(var9 + 1, var8, var9 + 1, var8 + 19);
        var1.drawLine(var9, var8, var9 + 6, var8 + 10);
        var1.drawLine(var9 + 1, var8, var9 + 7, var8 + 10);
        var1.drawLine(var9, var8, var9 - 6, var8 + 10);
        var1.drawLine(var9 + 1, var8, var9 - 5, var8 + 10);
    }
